      ...
      <div class="px-4 py-5 my-5 text-center">
        ...
        <div class="col-lg-6 mx-auto">
          <p class="lead mb-4">
            ...
            GoFood empowers restaurants to manage their online presence with
            ease. Our platform provides a simple and efficient system for
            adding, listing, updating, and deleting menu items, ensuring your
            online menu is always accurate and up-to-date.
          </p>
